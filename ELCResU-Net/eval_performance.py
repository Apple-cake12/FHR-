# %%
from unet_model import LCResUNet
...
model_21 = LCResUNet(1, 3, kernel_size=kernel_size[0]).to(device)
model_21.load_state_dict(torch.load('./trained_model/model_GMU_21.pt'))

model_31 = LCResUNet(1, 3, kernel_size=kernel_size[1]).to(device)
model_31.load_state_dict(torch.load('./trained_model/model_GMU_31.pt'))

model_61 = LCResUNet(1, 3, kernel_size=kernel_size[2]).to(device)
model_61.load_state_dict(torch.load('./trained_model/model_GMU_61.pt'))

model_81 = LCResUNet(1, 3, kernel_size=kernel_size[3]).to(device)
model_81.load_state_dict(torch.load('./trained_model/model_GMU_81.pt'))
